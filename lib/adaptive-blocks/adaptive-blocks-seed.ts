...
const proofBlocks: SeedBlock[] = [
  {
    key:     "proof_default",
    content: ci(
      "Meer dan 200 B2B-bedrijven groeien met Mister Chameleon",
      "Van scale-ups tot enterprise: onze klanten zien gemiddeld 34% meer leads uit hetzelfde websiteverkeer.",
      "Bewezen resultaten",
      [
        { title: "34% meer leads",         text: "Gemiddeld resultaat na 90 dagen personalisatie, gemeten over 200+ actieve B2B-klanten in Nederland en België." },
        { title: "3× hogere engagement",   text: "Bezoekers die relevante content zien, klikken vaker, scrollen dieper en nemen eerder contact op." },
        { title: "No-code implementatie",  text: "Eén snippet in uw CMS en u bent live — geen developer nodig, geen IT-traject, geen cookiemelding." },
      ],
    ),
  },
  {
    key:     "proof_cases",
    content: ci(
      "Concrete resultaten van bedrijven als het uwe",
      "Bekijk hoe B2B-bedrijven hun lead-conversie verbeterden met gerichte personalisatie. Cijfers, aanpak en lessen.",
      "Klantcases",
      [
        { title: "+47% trial-aanmeldingen",  text: "Een SaaS-bedrijf personaliseerde de hero op kanaalherkomst. In 8 weken steeg het aantal proefaccounts met 47%." },
        { title: "–32% bounce",              text: "Een B2B-dienstverlener zette een gepersonaliseerde hero in voor zoekmachineverkeer. Uitvalpercentage daalde sterk." },
        { title: "2× meer demo-aanvragen",   text: "Intent-gebaseerde CTA's zorgden bij een e-commerceplatform voor een verdubbeling van het aantal kwalificatiestappen." },
      ],
    ),
  },
  {
    ...
    content: ci(
      ...
      "Analisten en vakpers onderschrijven de aanpak: relevantie verhogen zonder third-party cookies of complexe IT-trajecten.",
      "Erkend door de industrie",
      [
        { title: "Cookievrije personalisatie", text: "Alle segmentering werkt op basis van gedrag en context — geen third-party data, volledig AVG-conform." },
        { title: "Erkend door vakpers",        text: "Mister Chameleon wordt aangehaald door analisten en marketingvakbladen als voorbeeld van privacy-first personalisatie." },
        { title: "Geen IT-traject vereist",    text: "Marketeers beheren de regels zelf. IT hoeft alleen eenmalig de snippet te plaatsen — dat is alles." },
      ],
    ),
  },
  {
    key:     "proof_platform",
    content: ci(
      "Beschikbaar wanneer uw bezoekers er zijn",
      "99,9% uptime SLA. Sneller dan een cookiebanner. Volledig AVG-proof voor de Europese markt.",
      "Betrouwbare infrastructuur",
      [
        { title: "99,9% uptime SLA",         text: "Onze edge-infrastructuur garandeert beschikbaarheid — ook tijdens piekmomenten en campagneperiodes." },
        { title: "< 50 ms responstijd",      text: "Personalisatie-beslissingen worden aan de edge genomen. Geen merkbare vertraging voor uw bezoekers." },
        { title: "AVG-proof by design",      text: "Geen persoonsgegevens opgeslagen, geen cookies geplaatst. Uw juridische team tekent er graag voor." },
      ],
    ),
  },
  {
    key:     "proof_stats",
    content: ci(
      "+34% leads, –28% bounce, 3× hogere engagement",
      "Gemiddelde resultaten over alle actieve klanten na 90 dagen. Uw resultaten hangen af van sector en startpositie.",
      "De cijfers spreken",
      [
        { title: "+34% meer leads",        text: "Meer relevante bezoekers converteren naar lead omdat ze direct de boodschap zien die bij hen past." },
        { title: "–28% lager bounce",      text: "Minder bezoekers verlaten de pagina meteen: de eerste indruk klopt met hun verwachting." },
        { title: "3× hogere engagement",   text: "Klikken, scrollen, formulieren invullen — relevantie drijft elke interactie omhoog." },
      ],
    ),
  },
  {
  ...
  },
  {
    ...
    content: ci(
      "3× meer gekwalificeerde demos na personalisatie",
      "High-intent bezoekers zien direct de waardepropositie die aansluit op hun fase — en boeken sneller een gesprek.",
      "ROI in 90 dagen",
      [
        { title: "3× meer demo-aanvragen",  text: "Bezoekers met hoge koopintentie zien een CTA die direct op hun fase inspeelt — en klikken vaker." },
        { title: "Hogere show-up rate",     text: "Leads die via een gepersonaliseerde pagina binnenkomen, komen vaker opdagen bij geplande demo's." },
        { title: "Sneller naar contract",   text: "Klanten die via Mister Chameleon converteren, ondertekenen gemiddeld 18 dagen eerder dan het marktgemiddelde." },
      ],
    ),
  },
  {
