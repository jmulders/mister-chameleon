/**
 * ISO 3166-1 alpha-2 country codes + English names, for country-targeting UI.
 * Codes match what geo headers / Leadinfo return (uppercased 2-letter).
 */
...
/** Human-readable name for an ISO code, or the code itself when unknown. */
export function countryName(code: string): string {
  return BY_CODE.get(code.toUpperCase()) ?? code.toUpperCase();
}

/** Resolve free text (a code or a name) to a valid ISO code, or null. */
