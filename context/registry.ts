...
export const CONTEXT_VARIABLES: readonly ContextVariableDef[] = [
  ...
  // ── Enrichment — netbeheerder PC6 energy (D5 Fase 2, kleinverbruik) ─────────
  {
    key:              "locationPc6AvgGasM3",
  ...
  { key: "locationPctHouseholdsWithChildren", label: "Location % households with children", description: "% households with children in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 28.4 },
  { key: "locationPctSinglePersonHouseholds", label: "Location % single-person households", description: "% single-person households in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 41.2 },
  { key: "locationAvgHouseholdSize", label: "Location avg household size", description: "Average household size in the visitor's buurt (persons, CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 2.1 },
  { key: "locationPctAge0_15", label: "Location % age 0-15", description: "% inhabitants aged 0-15 in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 15.0 },
  { key: "locationPctAge15_25", label: "Location % age 15-25", description: "% inhabitants aged 15-25 in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 12.0 },
  { key: "locationPctAge25_45", label: "Location % age 25-45", description: "% inhabitants aged 25-45 in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 28.0 },
  { key: "locationPctAge45_65", label: "Location % age 45-65", description: "% inhabitants aged 45-65 in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 27.0 },
  { key: "locationPctAge65Plus", label: "Location % age 65+", description: "% inhabitants aged 65+ in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 18.0 },
  { key: "locationPctMarried", label: "Location % married", description: "% inhabitants married in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 40.0 },
  { key: "locationPctUnmarried", label: "Location % unmarried", description: "% inhabitants unmarried in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 45.0 },
  { key: "locationPctDivorced", label: "Location % divorced", description: "% inhabitants divorced in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 8.0 },
  { key: "locationPctWidowed", label: "Location % widowed", description: "% inhabitants widowed in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 6.0 },
  { key: "locationPctSingleFamilyHomes", label: "Location % single-family homes", description: "% single-family homes in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 55.0 },
  { key: "locationPctMultiFamilyHomes", label: "Location % multi-family homes", description: "% multi-family homes in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 45.0 },
  { key: "locationPctDetachedHomes", label: "Location % detached homes", description: "% detached single-family homes in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 12.0 },
  { key: "locationPctOwnerOccupied", label: "Location % owner-occupied", description: "% owner-occupied dwellings in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 58.0 },
  { key: "locationPctRental", label: "Location % rental", description: "% rental dwellings in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 42.0 },
  { key: "locationPctSocialHousing", label: "Location % social housing", description: "% social-housing dwellings in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 27.0 },
  { key: "locationPctHigherEducated", label: "Location % higher educated", description: "% higher-educated (HBO/WO of the three levels) in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 38.0 },
  { key: "locationPctLowerEducated", label: "Location % lower educated", description: "% lower-educated (of the three levels) in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 30.0 },
  { key: "locationMedianHouseholdWealth", label: "Location median household wealth (€)", description: "Median private-household wealth in the visitor's buurt (euro, CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 210000 },
  { key: "locationAvgIncomePerEarner", label: "Location avg income per earner (€)", description: "Average income per earner in the visitor's buurt (euro, CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 39000 },
  { key: "locationPovertyPct", label: "Location poverty (%)", description: "% persons in poverty in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 6.5 },
  { key: "locationCarsPerHousehold", label: "Location cars per household", description: "Cars per household in the visitor's buurt (ratio, CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 1.1 },
  { key: "locationPctNonPetrolCars", label: "Location % non-petrol cars", description: "% non-petrol cars (EV/other-fuel proxy) in the visitor's buurt (CBS 85984NED).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 18.0 },
  { key: "locationAvgElectricityFeedback", label: "Location avg electricity feed-in (kWh)", description: "Average electricity feed-in per home in the visitor's buurt (kWh/year, CBS 85984NED) — a direct solar signal.", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 850 },
  // ── Enrichment — EP-Online energielabel (per adres, D5 Fase 3) ──────────────
  { key: "locationEnergyLabel", label: "Location energy label (raw)", description: "Raw energy-label class at the form address, e.g. \"A\", \"C\" (EP-Online). Internal signal — visitor display is licence-gated (epLabelDisplayAllowed).", type: "string", source: "enrichment", operators: OPS_STRING, availableToRules: true, availableToAI: true, exampleValue: "A" },
  { key: "locationEnergyLabelBand", label: "Location energy-label band", description: "Coarse energy-label band at the form address: green (A/B), amber (C/D), red (E/G). Safe aggregate for segmentation (EP-Online).", type: "string", source: "enrichment", operators: OPS_STRING, availableToRules: true, availableToAI: true, exampleValue: "green" },
  { key: "locationEnergyIndex", label: "Location energy index", description: "EP-Online energy index at the visitor's form address.", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 1.2 },
  { key: "locationBuildingEnergyDemand", label: "Location building energy demand", description: "Building energy demand (energiebehoefte) at the visitor's form address (EP-Online).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 90 },
  { key: "locationRenewableShare", label: "Location renewable share", description: "Renewable-energy share (aandeel hernieuwbaar) at the visitor's form address (EP-Online).", type: "number", source: "enrichment", operators: OPS_NUMBER, availableToRules: true, availableToAI: true, exampleValue: 35 },
  { key: "locationEnergyLabelValidUntil", label: "Location energy-label valid until", description: "Energy-label validity end date (ISO) at the visitor's form address (EP-Online).", type: "string", source: "enrichment", operators: OPS_STRING, availableToRules: true, availableToAI: true, exampleValue: "2033-01-01" },
