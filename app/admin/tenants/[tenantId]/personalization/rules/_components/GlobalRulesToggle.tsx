    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-0.5">
          <p className="text-sm font-semibold text-neutral-900">Rules engine</p>
          <p className="text-xs text-neutral-500">
            {enabled
              ? "Rules are evaluated for every visitor request. Individual rules below can also be toggled."
              : "All rules are disabled for this tenant. Visitors will always receive the default plan."}
          </p>
        </div>
