    ...
    <div className="space-y-10 text-sm text-neutral-700">
      ...
      <section className="rounded-xl border border-neutral-200 bg-neutral-50 px-6 py-5">
        <div className="flex flex-col gap-3">
          {([
            ["1", "bg-indigo-100 text-indigo-700",  "Script tag in <head>",     "Your site loads. The browser fetches the snippet JS from Mister Chameleon, asynchronously, with no render blocking."],
