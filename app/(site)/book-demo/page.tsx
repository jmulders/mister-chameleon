 ...
 * /book-demo  (English)
 *
 * Calendly-style demo booking page backed by Google Calendar.
 * Server component — renders the page shell, metadata, and trust badges.
 * The interactive booking widget is BookDemoClient (client component).
 *
 * Locale variants:
 *   /nl/book-demo  — Dutch
 *   /de/book-demo  — German
...
import { BookDemoClient } from "./_components/BookDemoClient";
import { getBookDemoTranslations } from "./_components/translations";
