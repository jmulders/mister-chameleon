...
-- ── Migration ledger ──────────────────────────────────────────────────────────
-- This file is applied manually on prod (outside scripts/migrate.ts), so record
-- it in the ledger here. Idempotent: safe to re-run.
INSERT INTO public._migrations (filename)
VALUES ('20240101000166_design_token_sets.sql')
