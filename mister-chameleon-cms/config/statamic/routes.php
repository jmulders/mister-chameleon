...
return [
    ...
    */
    ...
    // Disabled: this is a headless CMS. All frontend routing is handled by
    // the Next.js app on port 3000. Enabling this would cause Statamic's
    // wildcard catch-all to intercept every GET request — including /api/* —
    // before our custom routes in web.php can handle them.
    'enabled' => false,
