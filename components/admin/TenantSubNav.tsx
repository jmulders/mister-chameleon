...
export function TenantSubNav({ tenantId, tenantName }: TenantSubNavProps) {
  ...
  const groups: PrimaryGroup[] = [
    ...
    },
    {
      ...
      prefix: `${base}/interest-profiles|${base}/audience-segments|${base}/behavior/journey|${base}/behavior|${base}/abm|${base}/leads`,
      icon:   ICONS.audience,
      items: [
        ...
        { label: "Lead Base", href: `${base}/leads`,                activePrefix: `${base}/leads` },
