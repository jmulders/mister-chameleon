...
export const STATEMENT_PRESET_CARDS: readonly DesignPresetCard[] = [
  ...
  },
  {
    "id": "dutch-orange",
    "name": "Dutch Orange",
    "description": "KNVB orange with black, and a red-white-blue accent set. Festive, bold, national.",
    ...
    "tokenOverrides": {
      "color": {
        ...
        "success": "#3f8a6a",
        "danger": "#b4534a",
        "gradient": "linear-gradient(135deg, #f36c21 0%, #111111 120%)",
        "gradientHero": "linear-gradient(180deg, #1a1205 0%, #a8460f 55%, #f36c21 100%)"
      },
      "typography": {
        "fontHeading": "'Oswald', system-ui, sans-serif",
        "fontBody": "'Work Sans', system-ui, sans-serif",
